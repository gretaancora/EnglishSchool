...
public class GetCurrWeekReportDAO implements GenericProcedureDAO{
    ...
    public Object execute(Object... params) throws DAOException {
        ...
        try {
            ...
            CallableStatement cs = conn.prepareCall("{call report_settimana_corrente_lezioni(?)}");
            ...
            throw new DAOException("Current week report error: " + e.getMessage());
        }
