...
import it.uniroma2.dicii.bd.model.domain.TeacherList;
...
public class GetStudentsListDAO implements GenericProcedureDAO{
    @Override
    public Object execute(Object... params) throws DAOException {
        ...
        try {
            ...
            CallableStatement cs = conn.prepareCall("{call lista_studenti()}");
            ...
            throw new DAOException("Get student list error: " + e.getMessage());
        }
